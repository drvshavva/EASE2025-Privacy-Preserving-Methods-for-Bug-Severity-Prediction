...
from task import create_log_reg_and_instantiate_parameters
...
class FlowerClient(NumPyClient):
    ...
    def evaluate(self, parameters, config):  # type: ignore
        ...
        loss = log_loss(self.y_test, prob, labels=self.unique_labels)
...
def client_fn(context: Context):
    ...
    model = create_log_reg_and_instantiate_parameters(penalty=RunConf.penalty,
                                                      c=RunConf.c,
                                                      max_iter=RunConf.max_iter,
                                                      solver=RunConf.solver,
                                                      multi_class=RunConf.multi_class,
