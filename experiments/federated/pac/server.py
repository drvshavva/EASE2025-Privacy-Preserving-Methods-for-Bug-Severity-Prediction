...
from experiments.federated.utils import get_model_parameters, load_test_dataset, set_model_params
from src.evalution import evaluatelog_result
from task import create_pac_and_instantiate_parameters
...
def server_fn(context: Context) -> ServerAppComponents:
    ...
    model = create_pac_and_instantiate_parameters(c=RunConf.c,
